function ExportScreen() {
  ...
  return (
    <div className="fade-in">
      ...
      {/* Tab: Master */}
      {tab === 'master' && (
        <div className="card" style={{ marginBottom:20, borderLeft:'3px solid #f5a623' }}>
        ...
        <div>
          ...
          <div className="card" style={{ marginBottom:20 }}>
            ...
            <div style={{ marginTop:12 }}>
              <button className="btn btn-green" onClick={handleExportAll}
              ...
              <div key={group.id} style={{ marginBottom:20 }}>
                <div style={{ display:'flex', alignItems:'center', gap:10,
                  ...
                  <span style={{ fontSize:11, color:'var(--text3)' }}>
                    {group.tables.length} tables {'-'} {groupTotal.toLocaleString()} rows
                  </span>
                  <div style={{ marginLeft:'auto' }}>
                    <button className="btn btn-ghost"
                      style={{ padding:'2px 7px', fontSize:11 }}
                      onClick={() => handleExportGroup(group)}
                      disabled={isExp || !canEdit}
                  ...
                  {group.tables.map(t => (
                    <div key={t} style={{ display:'flex', alignItems:'center',
                      ...
                      <div style={{ fontFamily:'var(--mono)', fontSize:11,
                        color:'var(--text2)', flex:1 }}>{t}.csv</div>
                      <div style={{ fontSize:11, color:'var(--text3)',
                        minWidth:55, textAlign:'right' }}>
                        {counts[t].toLocaleString()} rows
                      </div>
                      <button className="btn btn-ghost"
                        style={{ padding:'2px 7px', fontSize:11 }}
