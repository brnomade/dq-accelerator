                      ...
                      {cdsExp && (
                        <div style={{ overflowX:'auto' }}>
                          <table style={{ width:'100%', borderCollapse:'collapse',
                            ...
                            <thead>
                              <tr>
                                <th style={{ ...colHeaderStyle, textAlign:'left' }}>CDE</th>
                                <th style={{ ...colHeaderStyle, textAlign:'left' }}>Rule</th>
                                {CHECK_COLS.map(col => (
                                  <th key={col.key} style={colHeaderStyle} title={col.tip}>
                                    {col.label}
                                  </th>
                                ))}
                            ...
                            <tbody>
                              {cdsGroup.items.map((item, rowIdx) => {
